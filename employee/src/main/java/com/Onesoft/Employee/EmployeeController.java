...
//*******EMPLOYEES BY NAME***********///
	...
	@GetMapping(value="/findEmployeesbyage/{age}")
	
	public List<Employee> getEmpByAge(@PathVariable int age) throws NoAgeNameFound
	{
...
//public List<Employee> getEmpBySalary(@PathVariable)
